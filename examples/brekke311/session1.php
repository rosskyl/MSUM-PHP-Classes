...
// print_r($_REQUEST);
session_start();
include("dumpAssoc.php");
dumpAssoc($_SESSION);

/*
if (isset($_SESSION['numbers'])) $numbers=$_SESSION['numbers'];
if (isset($_SESSION['howmany'])) $howmany=$_SESSION['howmany'];
if (isset($_SESSION['smallest'])) $smallest=$_SESSION['smallest'];
if (isset($_SESSION['largest'])) $largest=$_SESSION['largest'];
*/
